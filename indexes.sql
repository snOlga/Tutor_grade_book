...
CREATE INDEX users_lessons_index_on_user_id ON users_lessons (user_id, lesson_id);
...
CREATE INDEX lessons_requests_index_on_sender_id ON lessons_requests USING HASH (sender_id, reciever_id);
