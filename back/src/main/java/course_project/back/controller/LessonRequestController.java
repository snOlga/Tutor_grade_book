...
public class LessonRequestController {
    ...
    public ResponseEntity<LessonRequestDTO> approveRequest(@PathVariable String id,
        ...
        LessonRequestDTO updatedLessonRequestDTO = lessonRequestService.updateApprovement(UUID.fromString(sanitizerService.sanitize(id)), sanitizerService.sanitize(lessonRequestDTO));
    ...
    public ResponseEntity<LessonRequestDTO> deleteRequest(@PathVariable String id) {
        boolean deleted = lessonRequestService.deleteById(UUID.fromString(sanitizerService.sanitize(id)));
    ...
    public ResponseEntity<LessonRequestDTO> createLessonRequest(@RequestBody LessonRequestDTO lessonRequestDTO) {
        LessonRequestDTO createdLessonDTO = lessonRequestService.create(sanitizerService.sanitize(lessonRequestDTO));
